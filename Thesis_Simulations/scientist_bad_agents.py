...
class Participant:
    ...
    def __init__(self, alpha, reporting_setting, bad_agent):        
        ...
        self.bad_agent = bad_agent                                           # boolean, true iff the scientist is a bad agent
    ...
    def report(self, num_bins, num_draws):
        ...
        self.reported_results = report(self.reporting_setting.name, self.alpha, bin_history, self.bad_agent)
...
def report(reporting_setting, alpha, bin_history, bad_agent):
    ...
    # overreport the number of '1's and underreport the number of '0's by a rate of alpha 
        ...
        if bad_agent:
            num_reported_zeros = num_reported_zeros * 0.75
            num_reported_ones = num_reported_ones * 1.25
